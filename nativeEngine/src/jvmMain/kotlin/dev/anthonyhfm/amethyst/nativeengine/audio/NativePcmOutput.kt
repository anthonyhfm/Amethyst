...
/**
 * JVM-facing PCM output with a direct-buffer producer path.
 *
 * Lifecycle and telemetry use UniFFI/JNA. Audio samples never become a Kotlin
 * `List`: [writeInterleaved] passes direct native-endian Float32 memory to the
 * preallocated native ring.
 *
