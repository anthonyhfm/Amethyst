...
object FocusNode : TransformNode() {
    ...
    override fun defaultState() = FocusNodeState()
                    ...
                    stroke.copy(
                        paint = GeometryPaint.Opacity(
                            ...
                            predicate = { point, _ ->
                                ...
                                var opacity = when {
                                    distance <= radius - feather -> 1f
                                    distance >= radius || feather <= 0f -> 0f
                                    else -> {
                                        val progress = ((radius - distance) / feather).coerceIn(0f, 1f)
    ...
    override fun NodeBody(
        ...
        val state = node.state as? FocusNodeState ?: return
